...
def test_wiring_verification():
    ...
    print()
    print("🎯 ANEMOMETER TO RJ11 CONNECTOR:")
    print("   Anemometer Green  → Use BLACK wire on Leroy connector")
    print("   Anemometer Black  → Use YELLOW wire on Leroy connector")
    print()
    print("🎯 RJ11 CONNECTOR TO Pi:")
    print("   Leroy BLACK wire  → Pi Pin 11 (GPIO17) - SIGNAL")
    print("   Leroy YELLOW wire → Pi Pin 6 (GND)    - GROUND")
    print()
    print("❗ CRITICAL CHECK:")
    print("   1. Is your signal wire (from anemometer GREEN) going to GPIO17?")
    print("   2. Is your ground wire (from anemometer BLACK) going to Pi GND?")
    print("   3. Are you using the correct Leroy connector wire colors?")
    print()
    print("💡 If unsure, try swapping the two wires and test again!")
    print("="*60)
